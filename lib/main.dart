...
import 'package:vm_flutter_demo/views/listview/budgets_list.dart';
...
class BudgetsRouter extends _$BudgetsRouter {
  @override
  GoRouter build() {
    return GoRouter(
          ...
          GoRoute(
              ...
              builder: (context, state) => Container(
                ...
                child: const Center(
                  *//*child: Button(
                    text: "Budgets List",*//*
                  *//*type: VMButtonType.primary,
                    action: () =>
                        context.pushNamed(VMBudgetsRoutes.budgetsList.name),*//*
                ),
              )),
...
class MyApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    //var routerProvider = ref.watch(budgetsRouterProvider);

    *//*return MaterialApp.router(
      debugShowCheckedModeBanner: false,
      theme: ThemeConstants.appthemes.first.data,
